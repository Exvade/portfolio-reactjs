    ...
    <div className="container">
      <div className="w-full px-4">
        <div className="max-w-xl mx-auto mb-10 text-center">
          <h2 className="mb-4 text-3xl font-bold text-primary sm:text-4xl lg:text-3xlxl">
            Contact Me
          </h2>
          <p className="text-base font-medium md:text-lg text-slate-500">Connect with Me and Share Your Thoughts. I&apos;m Here to Listen and Assist!</p>
        </div>
      </div>
      ...
      <form>
        <div className="w-full lg:w-2/3 lg:mx-auto">
          ...
          <div className="w-full px-4">
            <button className="w-full px-8 py-3 text-base font-semibold text-white transition duration-500 rounded-lg bg-primary hover:opacity-80 hover:shadow-lg">Submit</button>
          </div>
        </div>
      </form>
    </div>
